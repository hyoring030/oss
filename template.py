...
#https://github.com/hyoring030/oss
...
def dataset_stat(dataset_df):	
    #To-Do: Implement this function
    kk=dataset_df.groupby("target").size().to_frame()
    return len(dataset_df.columns)-1, kk.iloc[0][0],kk.iloc[1][0]
...
def split_dataset(dataset_df, testset_size):
    ...
    #rint(y_train.shape,y_test.shape)
...
if __name__ == '__main__':
    ...
    #x_train, x_test, y_train, y_test = split_dataset(data_df,0.4)
